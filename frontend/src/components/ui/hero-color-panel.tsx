...
// ── Icons defined first so they can be used in defaultTechStack ────────────────
    ...
    >
      ...
      <g mask={`url(#${maskId})`}>
        ...
        <path
          ...
          fill={`url(#${paint0Id})`}
        />
        <rect fill={`url(#${paint1Id})`} height={72} width={12} x={115} y={54} />
      </g>
      <defs>
        <linearGradient
    ...
    <HeroColorPanelsRoot {...props}>
      <HeroColorPanelsContainer className={containerClassName}>
        <HeroColorPanelsContent className={contentClassName}>
          ...
          <div
            className={cn("flex justify-center lg:justify-start", badgesWrapClassName)}
